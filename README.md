...
### To run search command in the cli: `uv run cli/keyword_search_cli.py search "your search query"`
### To run build command in the cli: `uv run cli/keyword_search_cli.py build`